...
* [goldbergyoni/nodebestpractices](https://github.com/goldbergyoni/nodebestpractices) - :white_check_mark: The largest Node.js best practices list (July 2019)
...
* [SheetJS/js-xlsx](https://github.com/SheetJS/js-xlsx) - :green_book: SheetJS Community Edition -- Spreadsheet Toolkit
...
* [alibaba/ice](https://github.com/alibaba/ice) - 🚀Simple and friendly front-end R&D system（简单而友好的前端研发体系 ）
...
* [hapijs/joi](https://github.com/hapijs/joi) - :office: The most powerful data validation library for JS
...
* [nightwatchjs/nightwatch](https://github.com/nightwatchjs/nightwatch) - End-to-end testing and continuous integration framework written in Node.js and using the Webdriver API
...
* [spencermountain/compromise](https://github.com/spencermountain/compromise) - modest natural-language processing in javascript
...
* [alibaba/rax](https://github.com/alibaba/rax) - [:tada: v1.0 released] The fastest way to build universal application.
...
* [lebab/lebab](https://github.com/lebab/lebab) - Turn your ES5 code into readable ES6. It does the opposite of what Babel does.
...
* [amwmedia/plop](https://github.com/amwmedia/plop) - Consistency Made Simple
...
* [deck-of-cards/deck-of-cards](https://github.com/deck-of-cards/deck-of-cards) - Deck of Cards
...
* [niieani/hashids.js](https://github.com/niieani/hashids.js) - A small JavaScript library to generate YouTube-like ids from numbers. Use it when you don't want to expose your database ids to the user.
...
* [bilibili-helper/bilibili-helper](https://github.com/bilibili-helper/bilibili-helper) - 哔哩哔哩 (bilibili.com) 辅助工具，可以替换播放器、去广告、推送通知并进行一些快捷操作
...
* [muicss/loadjs](https://github.com/muicss/loadjs) - A tiny async loader / dependency manager for modern browsers (884 bytes)
...
* [npm/cli](https://github.com/npm/cli) - a package manager for JavaScript, report bugs & get support at:
...
* [cloudflarearchive/backgrid](https://github.com/cloudflarearchive/backgrid) - Finally, an easily stylable semantic HTML data grid widget with a Javascript API that doesn't suck.
...
* [dmitry-zaets/redux-mock-store](https://github.com/dmitry-zaets/redux-mock-store) - A mock store for testing Redux async action creators and middleware.
...
* [i0natan/nodebestpractices](https://github.com/i0natan/nodebestpractices) - :white_check_mark: The largest Node.js best practices list (July 2019)
...
* [imba/imba](https://github.com/imba/imba) - Intuitive and powerful language for building webapps that fly
...
* [NickCarneiro/curlconverter](https://github.com/NickCarneiro/curlconverter) - convert curl commands to python, javascript, php, R, Go, Rust, Dart, JSON
...
* [pando-project/iotjs](https://github.com/pando-project/iotjs) - Platform for Internet of Things with JavaScript http://www.iotjs.net
...
* [gdi2290/angular-starter](https://github.com/gdi2290/angular-starter) - :tada: An Angular Starter kit featuring Angular (Router, Http, Forms, Services, Tests, E2E, Dev/Prod, HMR, Async/Lazy Routes, AoT via ngc), Karma, Protractor, Jasmine, Istanbul, TypeScript, TsLint, Codelyzer, Hot Module Replacement, @types, and Webpack
...
* [JexCheng/regulex](https://github.com/JexCheng/regulex) - :construction: JavaScript Regular Expression Visualizer.
...
* [canjs/canjs](https://github.com/canjs/canjs) - JS framework providing state management, templates & custom elements. Helps you build the impossible while keeping the common stuff easy.
...
* [chokcoco/jQuery-](https://github.com/chokcoco/jQuery-) - jQuery源码解读 -- jQuery v1.10.2
...
* [taylorhakes/fecha](https://github.com/taylorhakes/fecha) - Lightweight Javascript Date formatting and parsing
...
* [thednp/kute.js](https://github.com/thednp/kute.js) - KUTE.js is a native JavaScript animation engine featuring great code quality, badass performance, SVG morphing, stroke drawing and 2D & 3D transforms, CSS3 transforms, colors, as well as other CSS3 properties or presentation attributes.
...
* [leptosia/poi](https://github.com/leptosia/poi) - :zap: A zero-config bundler for JavaScript applications.
...
* [franciscop/cookies.js](https://github.com/franciscop/cookies.js) - 🍪 Delicious browser cookies
...
* [upash/poi](https://github.com/upash/poi) - :zap: A zero-config bundler for JavaScript applications.
* [fejes713/30-seconds-of-interviews](https://github.com/fejes713/30-seconds-of-interviews) - A curated collection of common interview questions to help you prepare for your next interview.
* [wix/detox](https://github.com/wix/detox) - Gray Box End-to-End Testing and Automation Framework for Mobile Apps
* [hyperapp/hyperapp](https://github.com/hyperapp/hyperapp) - 1 kB JavaScript micro-framework for building web applications
* [joemccann/dillinger](https://github.com/joemccann/dillinger) - The last Markdown editor, ever.
* [jxnblk/rebass](https://github.com/jxnblk/rebass) - :atom_symbol: React UI component library & design system, built with styled-components and styled-system.
...
* [mozilla-neutrino/neutrino-dev](https://github.com/mozilla-neutrino/neutrino-dev) - Create and build modern JavaScript projects with zero initial configuration.
* [getsentry/raven-js](https://github.com/getsentry/raven-js) - Official Sentry SDK for JavaScript
* [PanJiaChen/vueAdmin-template](https://github.com/PanJiaChen/vueAdmin-template) - a vue2.0 minimal admin template http://panjiachen.github.io/vueAdmin-template
* [walmik/scribbletune](https://github.com/walmik/scribbletune) - Create music with JavaScript in the browser and with Node.js in the terminal!
...
* [uBlockAdmin/uBlock](https://github.com/uBlockAdmin/uBlock) - uBlock: a fast, lightweight, and lean blocker for Chrome, Firefox, and Safari.
...
* [rofrischmann/fela](https://github.com/rofrischmann/fela) - State-Driven Styling in JavaScript
...
* [kelaberetiv/TagUI](https://github.com/kelaberetiv/TagUI) - RPA / CLI tool for automating user interactions
...
* [WolframHempel/golden-layout](https://github.com/WolframHempel/golden-layout) - The ultimate Javascript layout manager
* [sindresorhus/caprine](https://github.com/sindresorhus/caprine) - Elegant Facebook Messenger desktop app
* [smallwins/spacetime](https://github.com/smallwins/spacetime) - A lightweight javascript timezone library
...
* [wxyyxc1992/Web-Development-And-Engineering-Practices](https://github.com/wxyyxc1992/Web-Development-And-Engineering-Practices) - Web 开发基础、工程实践、应用架构与性能优化、React & Vue.js 实战教程系列文章
...
* [Ademking/CoolConsole](https://github.com/Ademking/CoolConsole) - CoolConsole.js Write Beautiful "console.Log()" with icons and styles
